...
<section id="s6"><div class="sec-head"><span class="sec-num">VI</span><h2>Come: spread & tecnica</h2></div>
 <p class="lead"><span class="drop">L</span>'arma del vincitore: la <b>presentazione appena sotto il pelo</b>.</p>
 <ul>
  <li><b>Esca:</b> minnow shallow-runner tarato per lavorare a <b>~5 cm sotto la superficie</b> (quota di lavoro, non taglia) + octopus/kona <b>bianco e viola</b>.</li>
